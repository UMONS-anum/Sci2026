...
def rolling_mean_50(years: np.array, days: np.array):
    '''
    ...
    Args:
        years (np.array) : les années de floraison
        days (np.array) : les jours de floraison

    Returns:
        np.array : les années pour lesquelles il y a une moyenne
        np.array : les moyennes sur 50 ans
    '''
    mean_years = []
    mean_days = []
